  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98] touch-manipulation",
  {
    variants: {
      variant: {
        ...
        // Custom Mercato variants
        cart: "bg-primary text-primary-foreground rounded-full shadow-button hover:bg-primary/90",
        cartOutline: "border-2 border-primary bg-card text-primary rounded-full hover:bg-primary/5",
        accent: "gradient-accent text-accent-foreground font-bold hover:opacity-90",
        icon: "bg-card text-foreground shadow-soft hover:shadow-card rounded-full",
      },
      size: {
